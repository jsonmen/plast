...
* [ ] **Direct GPU Pointers:** Explore exporting raw device memory pointers directly to the GPU instead of forcing the API user to manually trigger the host-to-device transfer loop.
